    ...
    <>
      <header className="font-shabnam">
        ...
        <div className="bg-white py-5">
          <div className="max-w-whole m-auto flex flex-row-reverse items-center justify-between text-heading">
            <Logo />
            <Link
              to="/"
            ...
            <form
              ...
              className="flex flex-row-reverse justify-between items-center border-chalk bg-chalk rounded-lg border-2 h-12 w-1/2 transition-all duration-300 focus-within:bg-white focus-within:border-primary"
            >
              <input
                className="h-full w-full bg-chalk focus-within:bg-white transition-all duration-300 pr-4 text-right text-base rounded-r-md outline-none"
                type="text"
