...
const ComModalDesk = ({ onClose }: IFavModal2) => {
  ...
  return (
    <>
      <div
        className="bg-white border-2 z-30 border-border font-shabnam w-fit h-fit absolute top-14 left-32 flex flex-col items-center justify-between p-3 pb-4 rounded-2xl animate-opacityin"
        id="containerCom"
      >
